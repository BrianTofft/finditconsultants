...
import { WHY_ITEMS } from "@/app/data";
    ...
    <section id="why" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <RevealOnScroll>
            <SectionHeader eyebrow="Derfor os" title={<>Uafhængig, uforpligtende <span className="text-orange italic">og gratis</span></>} sub="Vi er ikke et konsulenthus — vi er din uafhængige IT multi-sourcing partner hele vejen." />
          ...
          <RevealOnScroll delay={150}>
            <div className="relative rounded-3xl overflow-hidden shadow-xl group">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                ...
                <p className="text-white/85 text-sm leading-relaxed italic mb-5">FindITkonsulenter.dk har gjort det nemt for os at finde de rette IT-konsulenter. Hver gang har vi fået præsenteret relevante profiler hurtigt og effektivt — og til konkurrencedygtige priser.</p>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-white font-bold text-sm">Lasse Thomsen</div>
                    <div className="text-white/50 text-xs">IT Director · Nordic Bioscience A/S</div>
                  </div>
                </div>
                <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t border-white/10">
                  {["Rambøll","DSV","Rockwool","PFA","Coop","Guldager"].map(c => (
