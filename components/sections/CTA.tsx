    ...
    <section className="relative py-28 text-center overflow-hidden">
      ...
      <RevealOnScroll className="relative z-10 max-w-2xl mx-auto px-6">
        <div className="inline-flex items-center gap-3 mb-8">
          ...
          <span className="text-xs font-extrabold tracking-widest uppercase text-orange">Klar til at starte?</span>
          <span className="w-8 h-px bg-orange/60" />
        </div>
        ...
        <p className="text-white/55 text-lg leading-relaxed mb-4">
          Det er gratis, uforpligtende og hurtigt. Beskriv dit behov — vi aktiverer markedet og vender tilbage inden for 3 arbejdsdage.
        </p>
        <p className="text-white/35 text-sm mb-10 font-medium">
          Slut dig til <span className="text-orange font-bold">20+ virksomheder</span> der allerede har fundet deres konsulent via os
        </p>
        ...
        <div className="flex flex-wrap gap-3 justify-center mb-10">
          {["🆓 Gratis for kunder", "⚡ Svar inden 3 dage", "🔒 100% fortroligt", "🤝 Ingen binding"].map(b => (
